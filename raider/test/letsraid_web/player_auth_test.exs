defmodule LetsRaidWeb.PlayerAuthTest do
  use LetsRaidWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias LetsRaid.Players
  alias LetsRaidWeb.PlayerAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LetsRaidWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_player/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LetsRaidWeb.Endpoint.subscribe(live_socket_id)
