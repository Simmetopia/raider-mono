defmodule LetsRaidWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use LetsRaidWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import LetsRaidWeb.ConnCase
    end
  end

  setup tags do
    LetsRaid.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = LetsRaid.PlayersFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = LetsRaid.Players.generate_player_session_token(player)
