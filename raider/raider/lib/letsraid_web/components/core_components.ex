defmodule LetsRaidWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LetsRaidWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LetsRaidWeb.Gettext, "errors", msg, opts)
    end
  end
