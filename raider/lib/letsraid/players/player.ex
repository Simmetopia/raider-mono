defmodule LetsRaid.Players.Player do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, LetsRaid.Repo)
  ...
  """
  def valid_password?(%LetsRaid.Players.Player{hashed_password: hashed_password}, password)
